...
| 2 | 切分训练/测试集（X/y 约定、random_state） | ⬜ **待读** |
| 3 | GBDT 网格搜索 | ⬜ |
| 4 | binder_total 合体 | ⬜ |
| 5 | 置换重要性 | ⬜ |
| 6 | 1D PDP | ⬜ |
...
| ↓ | EDA cell 与 `train_test_split` 之间是否还有 cell | ⬜ **下次从这里往下滚，逐个读** | — |
| … | 切分训练/测试集（含 `train_test_split`） | ⬜ 待读 | 主干块 2 |
...
- [ ] EDA cell 与 `train_test_split` 之间的 cell（若有）← **下一站，往下滚逐个读**
- [ ] 块 2 切分训练/测试集
